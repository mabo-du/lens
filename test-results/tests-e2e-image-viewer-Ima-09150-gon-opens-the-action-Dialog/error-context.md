...
- Name: tests/e2e/image-viewer.spec.ts >> ImageViewer polygon mode >> right-click a committed polygon opens the action Dialog
- Location: tests/e2e/image-viewer.spec.ts:105:3
