...
- Name: tests/e2e/image-viewer.spec.ts >> ImageViewer polygon mode >> click 4 vertices + Enter commits a 4-vertex polygon via IPC
- Location: tests/e2e/image-viewer.spec.ts:50:3
