...
- Name: tests/e2e/image-viewer.spec.ts >> ImageViewer polygon mode >> Edit Memo... button in action Dialog opens RegionMemoDialog with codeName
- Location: tests/e2e/image-viewer.spec.ts:141:3
